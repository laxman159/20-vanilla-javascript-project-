...
function calculateWealth() {
  const wealth = data.reduce((acc, money) => (acc += user.money), 0);
...
showMillionairesBtn.addEventListener("click", showMillioneres);
